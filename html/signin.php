...
?>
   <main role="main" class="container">
    <form class="form-signin" action="signin.php" method="post" accept-charset="utf-8">
      ...
      <input type="email" id="email" name = "email" class="form-control" placeholder="Введите Email" required autofocus>
      <label for="pass" class="sr-only">Ваш пароль</label>
